        ...
        <div class="m-4 p-3 width-medium ">
            <div class="dashboard-content border-dashed p-3 m-4">
                ...
                <div class="schedules-content">
                    ...
                    <table class="table">
                        <c:forEach items="${dayNameList}" var="day" varStatus="LoopStatus">
                        <thead>
                        <tr class="d-flex">
                        ...
                        <c:forEach items="${recipePlanList}" var="recipePlan" varStatus="LoopStatus">
                        <tr class="d-flex">
                            <td class="col-2">${recipePlan.getMealName()}</td>
                            <td class="col-7">${recipePlan.getRecipeDescri()}</td>
                            <td class="col-1 center">
                                <a href="#" class="btn btn-danger rounded-0 text-light m-1">Usuń</a>
                            </td>
                            <td class="col-2 center">
                                <a href='<c:url value="/app/recipe/details?id=${recipePlan.getRecipeId()}"/>' class="btn btn-info rounded-0 text-light m-1">Szczegóły</a>
                            </td>
                        </tr>
                            </c:forEach>
                        </tbody>
